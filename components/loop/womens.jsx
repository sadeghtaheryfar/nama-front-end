                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] py-[0.5rem] text-[#EB82DA] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]"
                            >
                                <span className="hidden lg:block">
                                    {loadingExport
                                        ? "صبر کنید ..."
                                        : "خروجی اکسل مرکز تعالی بانوان"}
                                </span>
                            ...
                            <Link
                                ...
                                className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] bg-[#EB82DA] text-white py-[0.5rem] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]"
                            >
                                <span className="hidden lg:block">
                    ...
                    <div className="mt-[2rem] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        {data &&
                            ...
                            data?.data?.map((item) => (
                                <div
                                    key={item?.id}
                                    className="w-full border border-[#DFDFDF] rounded-[1rem] p-[1.5rem] group hover:border-[#EB82DA] transition-all duration-200"
                                >
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div>
                                            <Link
                                                ...
                                                className="hover:scale-[1.08] active:scale-[1] transition-[0.9s] flex justify-center items-center gap-2 text-[#EB82DA] font-semibold text-[14px]"
                                            >
                                    ...
                                    <div className="w-full">
                                        <Link
                                            ...
                                            className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] text-[#EB82DA] border border-[#EB82DA] group-hover:text-white group-hover:bg-[#EB82DA] transition-all duration-200 rounded-[0.5rem] w-full flex justify-center items-center p-[0.5rem] mt-[0.5rem]"
                                        >
                                            مشاهده بیشتر
                                        </Link>
                                    </div>
