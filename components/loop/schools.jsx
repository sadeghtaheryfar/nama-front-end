                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] py-[0.5rem] text-[#0068B2] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]"
                            >
                            ...
                            <Link
                                ...
                                className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] bg-[#0068B2] text-white py-[0.5rem] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]"
                            >
                                <span className="hidden lg:block">
                    ...
                    <div className="mt-[2rem] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        {data &&
                            ...
                            data?.data?.map((item) => (
                                <div
                                    key={item?.id}
                                    className="w-full border border-[#DFDFDF] rounded-[1rem] p-[1.5rem] group hover:border-[#0068B2] transition-all duration-200"
                                >
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div>
                                            <Link
                                                ...
                                                className="hover:scale-[1.08] active:scale-[1] transition-[0.9s] flex justify-center items-center gap-2 text-[#0068B2] font-semibold text-[14px]"
                                            >
                                    ...
                                    <div className="text-[20px] font-semibold mt-[1rem] group-hover:text-[#0068B2] transition-all duration-200">
                                        <p>مدرسه: {item?.title} </p>
                                    </div>
                                    ...
                                    <div className="w-full">
                                        <Link
                                            ...
                                            className="hover:scale-[1.04] active:scale-[1] transition-[0.9s] text-[#0068B2] border border-[#0068B2] group-hover:text-white group-hover:bg-[#0068B2] transition-all duration-200 rounded-[0.5rem] w-full flex justify-center items-center p-[0.5rem] mt-[0.5rem]"
                                        >
                                            مشاهده بیشتر
                                        </Link>
                                    </div>
