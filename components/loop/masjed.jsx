        ...
        <section className="mt-[2rem]">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    <Link href={'/loop/1/show'} className="py-[0.5rem] text-[#39A894] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]">
                        <span className="hidden lg:block">خروجی اکسل مسجد </span>
                    ...
                    <Link href={'/loop/1/show'} className="bg-[#39A894] text-white py-[0.5rem] px-[0.75rem] lg:px-[1rem] rounded-[0.5rem] shadow-lg flex justify-center items-center gap-2 text-[10px] lg:text-[14px]">
            ...
            <div className="mt-[2rem] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="w-full border border-[#DFDFDF] rounded-[1rem] p-[1.5rem] group hover:border-[#39A894] transition-all duration-200">
                    <div className="flex justify-between items-start">
                        ...
                        <div>
                            <Link href={'/loop/1/show'} className="flex justify-center items-center gap-2 text-[#39A894] font-semibold text-[14px]">
                    ...
                    <div className="text-[20px] font-semibold mt-[1rem] group-hover:text-[#39A894] transition-all duration-200">
                        <p>مسجد: حلقه شماره ۱ </p>
                    </div>

                    <div className="text-[14px] text-[#818595] mt-[0.5rem]">
                        <p>نام سرگروه : علی عسگری</p>
                        
                        <p>تعداد اعضای حلقه:  ۳۰ نفر</p>
                    </div>

                    <div className="w-full">
                        <Link href={'/loop/1/show'} className="text-[#39A894] border border-[#39A894] group-hover:text-white group-hover:bg-[#39A894] transition-all duration-200 rounded-[0.5rem] w-full flex justify-center items-center p-[0.5rem] mt-[0.5rem]">مشاهده بیشتر</Link>
                    </div>
                </div>
