  ...
  return (
    <div className="relative z-30 rounded-[20px] bg-white drop-shadow-3xl p-6 mb-16 lg:mt-2 container mx-auto md:p-9 xl:px-12 xl:py-[53px]">
      <div className="flex items-center justify-between gap-4">
        ...
        نام درخواست  مربوطه در اینجا قرار میگیرد  ( شماره  ۲۰۳ )
        </h2>
        <div className="text-sm font-semibold text-[#25C7AA] bg-[#25C7AA]/15 min-w-20 h-10 flex items-center justify-center rounded-lg px-3 lg:text-lg xl:text-2xl 2xl:text-[26px] lg:w-28 lg:h-12 xl:w-40 xl:h-14 2xl:w-48">
          تایید شده
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center gap-6 lg:gap-8 2xl:gap-10">
        ...
        <div className="grid grid-cols-1 gap-y-6 lg:grid-cols-2 lg:gap-x-9 xl:gap-x-20 2xl:grid-cols-[auto,auto,1fr] 2xl:gap-x-12">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between lg:justify-normal 2xl:gap-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between lg:justify-normal 2xl:gap-6 lg:justify-self-end">
            <h3 className="text-base min-w-fit lg:text-lg text-[#3B3B3B]">
