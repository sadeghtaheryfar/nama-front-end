...
const HeaderEslah2 = ({golden = true}) => {
  ...
  return (
    <header className="container mx-auto">
      <div className="grid grid-cols-3 items-center md:grid-cols-8 2xl:grid-cols-9 pt-10">
        ...
        <div style={{backgroundColor : lighterColor}} className="flex items-center min-w-fit justify-evenly gap-0.5 p-2 rounded-full justify-self-stretch col-span-4 text-white my-6 md:mx-2 md:col-start-4 2xl:col-start-6 2xl:col-span-3 md:row-start-1 lg:justify-self-end lg:gap-2 lg:p-3 xl:gap-3 xl:p-4 relative z-[12]">
