    ...
    <div className="relative z-30 rounded-[20px] bg-white drop-shadow-3xl p-6 mb-6 lg:mt-2 container mx-auto md:p-9 xl:px-12 xl:py-[53px]">
      ...
      <div className="flex flex-col justify-center gap-6 lg:gap-8 2xl:gap-10">
        ...
        <div className="grid grid-cols-1 gap-y-6 lg:grid-cols-2 lg:gap-x-4 xl:gap-x-20 2xl:grid-cols-[auto,auto,1fr]  2xl:gap-x-12">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between lg:justify-normal xl:gap-6 2xl:gap-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between lg:justify-normal xl:gap-6 2xl:gap-6 lg:justify-self-end">
            <h3 className="text-base min-w-fit lg:text-lg text-[#3B3B3B]">
