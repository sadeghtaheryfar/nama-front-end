    ...
    <div className="flex flex-col gap-4 lg:gap-6 xl:gap-9">
      ...
      <div className="hidden lg:flex items-start justify-between">
        ...
        <div className="w-full flex flex-col items-start">
          ...
          <span className="text-sm text-[#258CC7] mt-4 xl:mt-6 xl:text-lg 2xl:mt-8 2xl:text-[22px] min-w-fit 2xl:mr-[-10px]">تایید  رابط منطقه</span>
        ...
        <div className="w-full flex flex-col items-start">
          ...
          <span className="text-sm text-[#959595] mt-4 xl:mt-6 xl:text-lg 2xl:mt-8 2xl:text-[22px]  min-w-fit mr-[-28px] 2xl:mr-[-48px]">تایید معاونت اجرایی مسجد</span>
...
export default GardeshMoshahede1;
