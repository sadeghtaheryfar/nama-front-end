...
const DarkhasthaGozaresh = () => {
        ...
        const fetchRequests = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/darkhast-reports?item_id=${itemId}&role=mosque_head_coach`,
                    {
                        params: {
                            q: search,
                            sort,
                ...
                if (response.data.meta && response.data.meta.total) {
                    setTotalPages(
                        Math.ceil(response.data.meta.total / itemsPerPage),
                    );
                } else {
                    setTotalPages(
                        Math.ceil(response.data.data.length / itemsPerPage) ||
                            1,
                    );
                }
            } catch (error) {
    ...
    useEffect(() => {
        ...
        const fetching = async () => {
            try {
                const response = await axios.get(
                    `/api/info?item_id=${itemId}&role=mosque_head_coach`,
                );
                if (response.data) {
        ...
        <>
            <div className="flex flex-col justify-center items-center gap-5 lg:flex-row lg:justify-between">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-[2rem]">
                    <div
                        ...
                        className="cursor-pointer flex items-center justify-start gap-3 h-8 rounded-full bg-[#25C7AA]/5 border border-[#e22afc] xl:w-44 xl:h-12"
                    >
                    ...
                    <div
                        onClick={() => {
                            handleFilterChange({ ...filters, status: "done" });
                            setIsFilterOpen(false);
                        }}
                        className="cursor-pointer flex items-center justify-start gap-3 h-8 rounded-full bg-[#25C7AA]/5 border border-[#25C7AA] xl:w-44 xl:h-12"
                    >
                    ...
                    <div
                        ...
                        className="cursor-pointer flex items-center justify-start gap-6 h-8 rounded-full bg-[#77B7DC]/5 border border-[#77B7DC] xl:w-44 xl:h-12"
                    >
                        ...
                        <span className="text-sm font-semibold text-[#77B7DC] xl:text-lg 2xl:text-[22px]">
                            جاری
                        </span>
                    </div>
                    <div
                        ...
                        className="cursor-pointer flex items-center justify-start gap-5 h-8 rounded-full bg-[#D32F2F]/5 border border-[#D32F2F] xl:w-44 xl:h-12"
                    >
                        ...
                        <span className="text-sm font-semibold text-[#D32F2F] xl:text-lg 2xl:text-[22px]">
                            رد شده
                        </span>
                    </div>
                    <div
                        ...
                        className="cursor-pointer flex items-center justify-start gap-3 h-8 rounded-full bg-[#FFD140]/5 border border-[#FFD140] xl:w-44 xl:h-12"
                    >
            ...
            <div className="flex flex-col gap-4 lg:gap-16 xl:gap-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center md:justify-between">
                    ...
                    <div>
                        <Link
                            className="flex hover:scale-[1.03] active:scale-[1] transition-[0.9s] bg-sky-400 text-white whitespace-nowrap px-[1rem] py-[0.5rem] rounded-full"
                            href={`/${itemId}/invoice`}
                        >
                            صورت حساب
                        </Link>
                    ...
                    <div className="flex flex-col gap-4 md:flex-row md:items-center">
                        <div className="bg-[#F6F6F6] rounded-full flex items-center gap-2 px-3 flex-auto xl:px-6 h-[60px] lg:min-w-80 xl:w-[480px] 2xl:w-[560px] xl:max-w-lg">
                            <Image
                                ...
                                alt="#"
                                src={
                                    "/Images/masajed/kartabl-darkhast/Search.svg"
                                }
                            />
                            <input
                            ...
                            >
                                ...
                                >
                                    <Image
                                        ...
                                        alt="#"
                                        src={
                                            "/Images/masajed/kartabl-darkhast/filter.svg"
                                        }
                                    />
                            ...
                            >
                                ...
                                >
                                    <Image
                                        ...
                                        alt="#"
                                        src={
                                            "/Images/masajed/kartabl-darkhast/sort.svg"
                                        }
                                    />
                                    <span className="text-xs text-[#202020] min-w-fit lg:text-lg">
                                        {filters.direction
                ...
                >
                        ...
                        requests?.data?.map((request) => (
                            ...
                            >
                                <h2 className="text-sm text-[#202020] pb-3">
                                    {request?.request?.request_plan?.title ||
                                        "بدون عنوان"}{" "}
                                    {request?.request?.request_plan
                                        ?.single_step && (
                  ...
                  ${
                      request.status === "in_progress"
                          ? "text-[#258CC7] bg-[#D9EFFE]"
                          : request.status === "done"
                            ? "text-[#39A894] bg-[#DFF7F2]"
                            : request.status === "action_needed"
                              ? "text-[#D97706] bg-[#FEF3C7]"
                              : request.status === "pending"
                                ? "text-[#e22afc] bg-[#e94fff54]"
                                ...
                                <div className="bg-[#F6F6F6] rounded-lg flex items-center justify-between p-2">
                                    ...
                                    <span className="text-sm text-[#202020]">
                                        {request?.created_at
                                            ? toPersianDate(request?.updated_at)
                                            : "-"}
                                    </span>
                                </div>
                                ...
                                <Link
                                    href={
                                        `/${itemId}/kartabl-darkhast/darkhast?id=` +
                                        request?.request?.id
                                    }
                                >
