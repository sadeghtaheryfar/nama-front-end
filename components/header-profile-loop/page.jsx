...
const Header = ({ bgBox, bgRole }) => {
    ...
    return (
        <>
            ...
            {pathname != "/" && (
                <div
                    className="relative z-[12] px-2 py-1 border-x border-[#43637E] px-[1rem]"
            ...
            <div className="flex flex-col leading-7">
                ...
                <span className="text-[10px] lg:text-sm flex">
                    {translateRole(profile?.data?.arman_role)}
                </span>
            </div>
        </>
    );
