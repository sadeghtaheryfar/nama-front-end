          ...
          <div className=" p-6 scroll-kon ">
            <div className="bg-white shadow-md rounded mb-5 p-3 md:p-6 -mt-[70px] md:-mt-[100px] z-30">
              ...
              <div className="grid md:hidden">
                ...
                <div className="border-r-2 relative border-dashed border-[#25C7AA] ps-5 pb-5">
                  <h3 className="text-[#25C7AA] font-bold">  تایید شده معاونت طرح و برنامه</h3>
                  <p className="text-[12px] md:text-[16px]">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است 
                  </p>
            ...
            <div className="bg-white shadow-md rounded mb-5 p-3 md:p-6">
              <div className="flex justify-between">
                ...
                <div className="bg-green-100 text-[12px] md:text-[16px] rounded px-4 py-1 text-[#25C7AA]">
                  تایید شده{" "}
                </div>
              </div>
              <hr className="my-6" />
              ...
              <div className="flex mb-5 text-[12px] md:text-[15px]">
                ...
                <div className="font-bold mx-6 text-left">3.500.000 تومان</div>
              </div>

              <div className="text-[#3B3B3B]">
                نظر معاونت طرح و برنامه برای رد این درخواست:
              </div>
              <div className="my-4 font-bold text-justify">
                <p>
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                  استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و
                  مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی
