          ...
          <div className="p-6 scroll-kon ">
            <div className="bg-white shadow-md rounded mb-5 p-3 md:p-6 -mt-[70px] md:-mt-[100px] z-30">
              <div className="hidden md:grid md:grid-cols-5 gap-4 border-t-2 border-[#25C7AA] border-dashed mt-6 ">
                ...
                <div className="-mt-6">
                  <span className="inline-block bg-[#ffcb0e] rounded mb-4 p-2">
              ...
              <div className="grid md:hidden">
                ...
                <div className="border-r-2 relative border-dashed border-[#25C7AA] ps-5 pb-5">
                  <h3 className="text-[#ffcb0e] font-bold">در انتظار تایید  معاونت طرح و برنامه</h3>
                  <p className="text-[12px] md:text-[16px]">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است 
                  </p>

                  <span className="flex items-center justify-center absolute top-0 -right-2 bg-[#ffcb0e] rounded mb-4 p-1 w-[20px] h-[20px]">
            ...
            <div className="bg-white shadow-md rounded mb-5 p-3 md:p-6">
              <div className="flex justify-between">
                ...
                <div className="bg-amber-100 text-[12px] md:text-[16px] rounded px-4 py-1 text-[#FFC200]">
                  ارجاع جهت اصلاح
                </div>
              </div>
              <hr className="my-6" />
              ...
              <hr className="my-6" />
              <div className="flex mb-5 text-[12px] md:text-[15px]">
